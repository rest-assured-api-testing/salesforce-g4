Feature: SalesForces
  ...
  Scenario: Create a Account
    ...
    When I execute "/Account" request to be create in a Account
  ...
  Scenario: Create Contact
    ...
    When I execute "/Contact" request to be create in a Contact
  ...
  Scenario: Create a Opportunity
    ...
    When I execute "Opportunity" request to be create in a Opportunity
